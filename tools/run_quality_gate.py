...
QUICK_PROBES = (
    ...
    "save_lifecycle_feedback_probe.tscn",
    ...
    "freestyle_trick_depth_probe.tscn",
    "landing_readability_probe.tscn",
    "ground_balance_probe.tscn",
    "race_difficulty_quality_probe.tscn",
    "web_runtime_budget_probe.tscn",
    "long_session_stability_probe.tscn",
    "web_game_text_state_probe.tscn",
    "audio_settings_routing_probe.tscn",
    "audio_caption_accessibility_probe.tscn",
    "event_audio_identity_probe.tscn",
    "transition_catalog_probe.tscn",
    "garage_interface_feedback_probe.tscn",
    "bike_test_ride_probe.tscn",
    "bike_track_balance_matrix_probe.tscn",
    "surface_feedback_fidelity_probe.tscn",
    "bike_condition_feedback_probe.tscn",
    "crash_support_accessibility_probe.tscn",
    "saved_bike_builds_probe.tscn",
    "rider_outfit_slots_probe.tscn",
    "rider_equipment_wear_probe.tscn",
    ...
    "manual_transmission_academy_probe.tscn",
    "academy_surface_reading_probe.tscn",
    "results_navigation_probe.tscn",
    "podium_ceremony_probe.tscn",
    "player_race_metrics_isolation_probe.tscn",
    "activity_settlement_integrity_probe.tscn",
	"setup_result_history_probe.tscn",
	"run_plan_analysis_probe.tscn",
    "sponsor_relationship_probe.tscn",
    "sponsor_trackside_presentation_probe.tscn",
    "track_evolution_probe.tscn",
    "variable_weather_progression_probe.tscn",
    "academy_retry_identity_probe.tscn",
    "progression_pacing_probe.tscn",
    "progression_payoff_probe.tscn",
    "race_reputation_pacing_probe.tscn",
    "rider_debrief_probe.tscn",
    "academy_progression_presentation_probe.tscn",
    "career_systems_probe.tscn",
    "competitive_services_probe.tscn",
    "local_duel_flow_probe.tscn",
    "custom_tour_flow_probe.tscn",
    "challenge_rotation_identity_probe.tscn",
    "replay_lifecycle_probe.tscn",
    "ghost_eligibility_probe.tscn",
    "race_feature_contract_probe.tscn",
    "race_gate_launch_probe.tscn",
    "race_pack_launch_probe.tscn",
    "elimination_race_probe.tscn",
    ...
    "quarry_terrain_profile_cache_probe.tscn",
